...
class PlayersStatsAwayActivity : AppCompatActivity() {

    private val urlBase = "https://api.sportradar.com/"
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_players_stats_away)


        val resultado: Button = findViewById(R.id.buttonResultado)
        val local: Button = findViewById(R.id.buttonLocal)
        ...
        // Cuando se pulsa el boton Local se muestra la pantalla de estadísticas locales
        ...
        lifecycleScope.launch {
            ...
            val jugadores = equipoVisitante.players
            ...
            nombreJugador.forEachIndexed { index, textView ->
                ...
                } else if(index == jugadores.size && jugadores.size < nombreJugador.size){
                    textView.text = ""
                } else {
                    textView.text = ""
                }
            ...
            minutosJugador.forEachIndexed { index, textView ->
                ...
                } else if(index == jugadores.size && jugadores.size < minutosJugador.size){
                    textView.text = ""
                } else {
                    textView.text = ""
                }
            ...
            ptosJugador.forEachIndexed { index, textView ->
                ...
                } else if(index == jugadores.size && jugadores.size < ptosJugador.size){
                    textView.text = ""
                } else {
                    textView.text = ""
                }
            ...
            // Tiros de campo por cada jugador de la plantilla
            tirosJugador.forEachIndexed { index, textView ->
                ...
                } else if(index == jugadores.size && jugadores.size < tirosJugador.size){
                    textView.text = ""
                } else {
                    textView.text = ""
                }
            ...
            rebotesJugador.forEachIndexed { index, textView ->
                ...
                } else if(index == jugadores.size && jugadores.size < rebotesJugador.size){
                    textView.text = ""
                } else {
                    textView.text = ""
                }
            ...
            asistenciasJugador.forEachIndexed { index, textView ->
                ...
                } else if (index == jugadores.size && jugadores.size < asistenciasJugador.size) {
                    textView.text = ""
                } else {
                    textView.text = ""
                }
